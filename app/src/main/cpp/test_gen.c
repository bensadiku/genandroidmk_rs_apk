...
static const char *kTAG = "test_gen";
#define LOGI(...) \
...
/*
 *Called by the Java side to crash the app
 */
JNIEXPORT void JNICALL
Java_com_example_hellojnicallback_MainActivity_Crash(JNIEnv *env, jobject instance) {
    int *ptr2 = NULL;
    printf("%d", *ptr2);
}